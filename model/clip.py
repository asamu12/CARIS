...
class ResidualAttentionBlock(nn.Module):
    def __init__(self,
        ...
        if use_adapter:
            self.adapter= DTAdapter(d_model, txt_adapter_dim, txt_adapter_dim//2, txt_adapter_dim//16,txt_adapter_dim//4,txt_adapter_dim//16,txt_adapter_dim//4) #fc_in_channels, in_channels
